---
description: Verifies code works correctly. Checks tests pass, no runtime errors, type errors, linting issues, broken imports. Fast model for quick verification. Reports issues to manager.
mode: subagent
