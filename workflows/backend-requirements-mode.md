...
> **No Chat Output**: ALL responses go to `.windsurf/backend-requirements/<feature-name>.requirements.md`
...
Create `.windsurf/backend-requirements/<feature-name>.requirements.md`:
