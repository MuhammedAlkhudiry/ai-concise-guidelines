...
> **No Chat Output**: ALL responses go to `.windsurf/workshop/<topic>/iteration-N.md`
...
Each iteration goes to `.windsurf/workshop/<topic>/iteration-N.md`:
...
- **NO TIME ESTIMATES**—we're thinking about now, not scheduling
