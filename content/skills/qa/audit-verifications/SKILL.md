...
1. Audit the requested scope without editing files, configuration, CI, or repository settings. Use $systematic-work for exhaustive repository coverage.
...
8. Recommend a missing area or tool only for a named gap. Prefer extending the established path and state protection, feedback cost, maintenance,
   and confidence.
