...
- Include product surfaces, core journeys, UX surfaces, code surfaces, environments, signal sources, evidence paths, adapters, access gaps, recurring risks, and check playbooks.
...
- Product surfaces: backend, frontend, mobile, queues, scheduler, search, analytics, infrastructure, support, billing, or other relevant areas.
...
- Signal sources: source name, detected evidence, adapter/tool, configured or blocked status, and notes.
...
- Check playbooks: read-only commands, APIs, dashboards, or skills to use for each source, including baseline windows, impact slices, product journeys, scheduled work, data invariants, performance checks, monitoring gaps, and cost/capacity limits.
