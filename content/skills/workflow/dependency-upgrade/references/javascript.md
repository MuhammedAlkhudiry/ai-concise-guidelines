...
6. Apply small fixes directly: renamed options, config format updates, import/export changes, TypeScript errors, peer dependency alignment, script updates, and test utility updates.
