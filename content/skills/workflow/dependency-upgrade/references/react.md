...
5. Apply straightforward fixes directly: import changes, hook option changes, provider config changes, simple route/query/test updates, type fixes, and component prop renames.
