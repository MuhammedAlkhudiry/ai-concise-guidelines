---
name: deep-work
description: Exhaustive coverage work for broad inventories, manual item-by-item handling, and multi-source search where completion requires proof.
---
...
2. Load only the reference mode that matches the task:
