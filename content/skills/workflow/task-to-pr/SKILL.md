...
10. Report the PR link, verification performed, CI and mergeability status, and any known follow-up risks.

## Rules

- Do not treat the task as complete until verification has run or a real blocker is reported.
- Do not use an active project's main clone in place of a configured lane.
