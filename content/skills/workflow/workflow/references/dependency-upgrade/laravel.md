...
5. Apply straightforward fixes directly: config updates, renamed methods, changed defaults, simple service provider changes, factory/test helper updates, and assertion updates.
...
7. Use Artisan and Laravel checks through the project's established PHP boundary, normally `herd php artisan` in Herd Laravel repos.
