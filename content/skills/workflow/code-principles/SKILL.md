...
description: Code implementation, bug-fix, refactor, and review principles for directness, helper reuse, compatibility, data shape checks, and trust.
---
...
- Choose the highest rung that solves the problem: skip speculative work, reuse existing code, use the standard library or native behavior, or use an installed dependency.
