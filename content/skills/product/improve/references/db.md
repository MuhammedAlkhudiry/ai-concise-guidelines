...
2. Use `/workflow product-setup` for durable product setup, approved database evidence sources, safe read-only production query paths, and any needed `PRODUCT_SETUP.md` updates.
