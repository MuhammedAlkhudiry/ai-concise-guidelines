...
- For broad or multi-module code scans, split independent inspection slices across explorer subagents when available and delegation is allowed.
...
- Tie recommendations to concrete code paths, tests, runtime behavior, dependency evidence, or current docs.
- Call out weak evidence, missing access, risky contracts, or blocked verification.
