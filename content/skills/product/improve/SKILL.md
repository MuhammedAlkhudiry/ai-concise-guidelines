...
- `reconcile`: use `persistent-plans` to inspect existing durable plans, refresh drifted plans, and retire obsolete ones. Do not create or edit plan files unless the user explicitly asks.
