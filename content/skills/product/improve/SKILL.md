---
name: improve
description: Branch-specific improvement advisor for `/improve code` and `/improve db` requests with an explicit target.
---
...
- If the user omits the branch, ask them to choose `code` or `db` before inspecting.
