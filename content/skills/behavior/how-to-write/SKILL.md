...
- Vary sentence rhythm and allow natural irregularity. Split dense sentences before the reader has to backtrack.
...
- **Implemented result labels.** Prefix each completed outcome with one best-fit label: `[✨ **FEAT**]`, `[🐛 **FIX**]`, `[♻️ **REFACTOR**]`,
