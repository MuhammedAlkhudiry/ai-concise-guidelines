...
description: Expo/EAS mobile store releases for Google Play and App Store Connect, including release runs, submission status, credential intake, dashboard fallback, and readiness.
---
