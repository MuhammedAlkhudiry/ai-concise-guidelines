...
Use Maestro for repeatable mobile journeys, not unit-level behavior.

## Workflow

1. Inspect flow locations (`.maestro/`, `maestro/`, `e2e/`, `tests/`), package scripts, QA docs, app id, fixture data, and simulator/emulator state.
...
- Treat fixture data as part of the E2E contract; document reset commands, roles, records, and identifiers.
