...
3. Compare 2-4 credible alternatives across the relevant layers:
...
4. Check current real-world practice or official docs when tool choice, platform behavior, pricing, APIs, standards, or community norms matter.
5. Name the strongest path, the main reason it wins, and the critical risk that could overturn it.
6. Recommend the smallest proof step that would validate or reject the direction.
