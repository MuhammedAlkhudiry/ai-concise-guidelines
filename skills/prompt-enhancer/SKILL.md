...
description: Fast prompt enhancement with codebase context. Use when user wants to enhance a prompt, improve a question, or says "enhance this", "improve prompt", "/enhance", or wants better context before asking Claude. Responds in under 10 seconds.
---
...
> **Speed is critical**: Use parallel Haiku agents to scan quickly. No deep analysis—just enough context to make the prompt actionable.
...
2. **Spawn parallel Haiku scouts** — Quick codebase scans (3-5 agents max)
...
Launch **3-5 parallel Task agents** with `model: haiku` for speed:
...
**Rules for scouts:**
- Use `model: haiku` — fastest responses
...
- **USE HAIKU** — All scouts use `model: haiku`
