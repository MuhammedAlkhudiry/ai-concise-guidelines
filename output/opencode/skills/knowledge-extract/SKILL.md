...
description: Extract learnings from sessions into permanent project knowledge. Use when user says 'extract knowledge', 'digest sessions', 'save learnings', or wants to close sessions and preserve insights. AI proposes, user approves.
---
